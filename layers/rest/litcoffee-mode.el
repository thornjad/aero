;;; litcoffee-mode.el --- major mode for Literate CoffeeScript -*- lexical-binding: t; -*-
;;
;; Copyright (C) 2019 Jade Michael Thornton
;; Copyright (C) 2014 Syohei Yoshida
;;
;; Author: Jade Michael Thornton
;; URL: https://gitlab.com/thornjad/litcoffee-mode
;; Version: 0.9.0
;; Package-Requires: ((coffee-mode "0.6.3"))
;;
