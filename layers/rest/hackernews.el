...
;; Copyright (C) 2012-2014 The Hackernews.el Authors

;; Author: Lincoln de Sousa <lincoln@comum.org>
;; Maintainer: Jade Michael Thornton
;; Version: 0.6.2
...
(defvar hackernews-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map "\t"            #'hackernews-next-item)
    (define-key map [backtab]       #'hackernews-previous-item)
    map)
