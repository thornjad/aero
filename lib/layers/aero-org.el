...
(defun replace-thornlog-placeholders (template prev-day-date prev-day-goals prev-day-notes blocked-message)
...
(defun new-day-insert ()
  ...
  (let* ((template (with-temp-buffer
         ...
         (new-day-entry (replace-thornlog-placeholders
                         template prev-day prev-goals prev-notes blocked-message)))
