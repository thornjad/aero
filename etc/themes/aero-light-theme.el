...
(let ((class '((class color) (min-colors #xFF)))
      ...
      (aero-faded-red      "#ff6655")
      ;; (aero-faded-orange   "#ff8700")
      (aero-faded-yellow   "#ECBE7B")
      (aero-faded-green    "#99bb66")
      (aero-faded-blue     "#2257A0")
      (aero-faded-cyan     "#5699AF")
      (aero-faded-magenta  "#c678dd")
  ...
  (custom-theme-set-faces
   ...
   `(region ((t (:background ,aero-grey4))))
   `(secondary-selection ((t (:background ,aero-faded-blue))))
   ...
   `(match ((t (:foreground ,aero-bright-blue :background ,aero-faded-blue))))
