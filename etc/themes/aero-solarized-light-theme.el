...
(let ((class '((class color) (min-colors #xFF)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-inactive ((t (:background ,aero-grey1 :foreground ,aero-grey3 :box nil))))
...
(provide-theme 'aero-solarized-light)
