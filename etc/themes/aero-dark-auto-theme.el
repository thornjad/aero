...
(autothemer-deftheme
 aero-dark-auto "Outgoing Aero dark theme using autothemer"
 ...
 ((default (:background aero-bg :foreground aero-fg :font "Victor Mono" :height 150))
