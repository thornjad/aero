...
(let ((class '((class color) (min-colors #xFF)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((t (:background ,aero-faded-black :foreground ,aero-fg :box nil))))
   `(mode-line-inactive ((t (:background ,aero-bg-alt :foreground ,aero-grey3 :box nil))))
   ...
   `(region ((t (:background ,aero-grey0))))
   ...
   `(font-lock-keyword-face ((t (:foreground ,aero-faded-green))))
...
(provide-theme 'aero-solarized-dark)
